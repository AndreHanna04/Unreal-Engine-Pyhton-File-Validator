...
if not UNREAL_AVAILABLE:
    raise RuntimeError("Unreal framework not available, please run the script from the unreal editor")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="validates assets under an Unreal content path")
    parser.add_argument("--directory", type=str, default="/Game")
    ...
    context = UnrealContext(args.directory)
